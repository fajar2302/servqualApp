...
<body class="sb-nav-fixed">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link collapsed" href="hasil.php"> Hasil Perhitungan </a>
                        ...
                        <!-- <a class="nav-link" href="#" id="bantuan">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Bantuan
                        </a> -->
                    </div>
    ...
    $(document).ready(function() {
        // kondisi kelola kuesioner di klik
        $('#main-container').load('tabel-olah.php');

        $('#pengujian').on('click', function(e) {
            e.preventDefault();
            $('#main-container').load('pengujian-page/pengujian-page.php');

        })
        $('#servqual').on('click', function(e) {
            e.preventDefault();
            $('#main-container').load('servqual-page/servqual-page.php');
